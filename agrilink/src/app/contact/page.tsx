...
export default function Contact() {
  ...
  return (
    <>
      <Head>
        <title>Contact Us - AgriLink Sri Lanka</title>
        <meta name="description" content="Get in touch with AgriLink. Contact us for support, partnerships, or general inquiries about agricultural pricing and market intelligence." />
        <meta name="keywords" content="AgriLink contact, agricultural support, Sri Lanka farming, market prices contact" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="icon" href="/favicon.ico" />
      </Head>

      <main className="min-h-screen bg-gradient-agrilink">
        {/* Navigation */}
        ...
        {/* Hero Section */}
        <div className="relative bg-gradient-hero py-16 md:py-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center animate-fade-in-up">
              ...
              <p className="text-xl md:text-2xl text-gray-600 max-w-3xl mx-auto mb-8">
                We're here to help you succeed in agriculture. Reach out to us for support, partnerships, or any questions about AgriLink.
              </p>
            </div>
          </div>
        </div>
                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">123 Agricultural Hub<br />Colombo 07, Sri Lanka</p>
                    </div>
                  </div>
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    ...
                    className="w-full btn-agrilink text-white py-4 px-6 rounded-lg font-semibold text-lg transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2"
                  >
                    {isSubmitting ? (
                      <>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Find quick answers to common questions about AgriLink
              </p>
            </div>
        ...
        <footer className="bg-gray-900 text-white py-12">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div className="md:col-span-2">
                <div className="flex items-center mb-4">
                  <h3 className="text-2xl font-bold text-green-400">AgriLink</h3>
                  <span className="ml-2 text-gray-400">Sri Lanka</span>
                </div>
            ...
            <div className="border-t border-gray-700 mt-8 pt-8 text-center">
              <p className="text-gray-400">© 2025 AgriLink Sri Lanka. All rights reserved.</p>
            </div>
          </div>
        </footer>
      </main>
