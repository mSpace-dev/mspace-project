    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#edd7c3] via-[#6a6ba7] to-[#d8b5bc] p-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-2xl p-8">
        <div className="mb-8 text-center">
          ...
          <p className="text-gray-600">Sign up to manage customers, sellers, and business insights</p>
        </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-gray-600">
            ...
            <Link href="/" className="font-medium text-[#6a6ba7] hover:text-[#a07b9c] transition-colors">
              Sign in here
            </Link>
          </p>
        </div>
